...
if (isset($_POST['btn_update_clinic'])) {
            ...
            foreach ($_FILES['upload_pics']['name'] as $key => $val) {
                ...
                if (in_array($fileType, $allowTypes)) {
                    ...
                    if (move_uploaded_file($_FILES["upload_pics"]["tmp_name"][$key], $targetFilePath)) {
                        ...
                        // get the clinic id of this newly updated clinic
...
<head>
    ...
    <title>Update Clinic | Fur-Kanlungan </title>
    <!-- Bootstrap 5 CDN -->
    ...
    <link rel="stylesheet" href="../css/admin_clinic_update.css">
    <!-- css for header.php -->
...
<body>
    ...
    <div class="clinic min-vh-100">
        <div class="list_clinic">
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" id="update_clinic_form" method="post" enctype="multipart/form-data">
                <div class="form">
                    <div class="clinic_short_details">
                        ...
                        <div id="title" style="text-transform:capitalize">
                            <h4 class="mb-4">Update
                                ...
                                $clinic_name  = $description = "";
                                $services  = $email = "";
                                $owner = $contact = $open_hours = "";
                                //    get clinic name since you can't pass pass the clinic name as a get variable using javascript
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "(clinic_name not retrieved)";
                                }
                                ?>
                ...
                <div class="update_button  mt-4">
                    <input type="submit" class="btn btn-primary btn_update_clinic" name="btn_update_clinic" id="btn_update_clinic" value="update">
                </div>
            </form>
        </div>
    </div>
