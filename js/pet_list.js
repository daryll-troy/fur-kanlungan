...
$(document).ready(function () {
    ...
    $("#pet_category").change(function () {
        ...
        if (pc !== "none") {
            ...
            $.ajax({
                // This will not do anything since there is no $_POST['pc'] anywhere in pet-list.php
                url: 'pet-list.php',
                method: 'get',
                data: 'pc=' + pc
...
$(document).ready(function () {
    $("#breed").change(function () {
        ...
        if (bc !== "none") {
            ...
            $.ajax({
                // This will not do anything since there is no $_POST['bc'] anywhere in pet-list.php
                url: 'pet-list.php',
                method: 'get',
                data: 'bc=' + bc
